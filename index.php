...
<head>    
  ...
  <meta name="description" content="CIROTEC es una empresa de ingeniería y servicios del sector metal mecanico y automatizacion, enfocada a satisfacer las necesidades de diseño, proyecto, producción y servicio que el cliente requiera y agregando lo que nosotros observemos en sus procesos para mejorar los mismos, con sentido inovador.">
  <title>CIROTEC | Empresa de ingeniería y diseño en Torreón, Coahuila</title>
</head>
<body>
  <!-- Navbar -->
  ...
  <div class = "container pagebody">
    ...
    <div class = "row">
      ...
      <div class ="col-sm-1">
        <a href="#wrangler" id="wrangler" data-toggle="tooltip" data-placement="top" title="WRANGLER SA DE CV"><img class = "logo-cliente" src = "https://cirotec.mx/img/wrangler.jpg" alt ="logo de wrangler"></a>
      </div>
      <div class ="col-sm-1">
        <a href="#nlt" id="nlt" data-toggle="tooltip" data-placement="top" title="NLT SA DE CV"><img class = "logo-cliente" src = "https://cirotec.mx/img/nlt.jpg" alt = "logo de nlt"></a>
      </div>
      <div class ="col-sm-1">
